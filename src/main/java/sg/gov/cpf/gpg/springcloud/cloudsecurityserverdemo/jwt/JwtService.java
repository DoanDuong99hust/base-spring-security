...
public class JwtService {
    ...
    private <T> T extractClaim(java.lang.String token, Function<Claims, T> claimsResolvers) {
    ...
    public boolean isCorrectToken(String token, UserDetails userDetails) {
    ...
    // TODO: should return in milisecond
